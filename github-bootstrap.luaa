local uiUrl = 'https://raw.githubusercontent.com/atrfsdfdsd-ux/arasdasd/main/new.lua'

assert(
    not uiUrl:find('YOUR_USERNAME', 1, true)
    and not uiUrl:find('YOUR_REPO', 1, true),
    'Edit uiUrl in github-bootstrap.lua first.'
)
...
assert(
    type(source) == 'string'
    and source:find('-- Vape Modern UI 1.0.0', 1, true) == 1,
    'The GitHub file is not the Vape Modern new.lua.'
)
...
local upstreamLoader = game:HttpGet(
    'https://raw.githubusercontent.com/7GrandDadPGN/VapeCompiled/main/loader.lua',
    true
)
